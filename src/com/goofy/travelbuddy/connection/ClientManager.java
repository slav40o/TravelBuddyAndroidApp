...
public class ClientManager {
	...
	private void saveToken(HttpResponse responce) throws IllegalStateException, IOException {
		Gson gson = new Gson();
		...
		Log.d("TOKEN", userInfo.accessToken);
		
		// TO DO: save info to Shared Preferences
	}
